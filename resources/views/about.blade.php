		...
		<div class="page-wrap" id="root">
			...
			<header class="header header--fixed">
				<div class="header__inner">
					<div class="header__logo"><a href="/"><img src="assets/img/logo.png" alt="" style="width: 61px;"/></a></div>
				...
				<section class="awe-section">
					<div class="container">
						...
						<div class="page-title pb-40">
							...
							<p class="page-title__text">Enthusiastic and ambitious person</p>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-0 col-lg-offset-1 ">
								...
								<!--  -->
								<div class="mt-30">
									<h2 class="about__title">Galang Fajar S</h2>
									...
									<div class="progress">
										...
										<div class="progress__wrap">
											<div class="progress__bar" data-progress-percent="30" data-timing="ease" data-duration="1000" data-delay="500"></div><span class="progress__number">30%</span>
										</div>
									</div><!-- End / progress -->
									...
									<div class="progress">
										...
										<div class="progress__wrap">
											<div class="progress__bar" data-progress-percent="45" data-timing="ease" data-duration="1000" data-delay="500"></div><span class="progress__number">45%</span>
										</div>
									</div><!-- End / progress -->
									...
									<div class="progress">
										...
										<div class="progress__wrap">
											<div class="progress__bar" data-progress-percent="35" data-timing="ease" data-duration="1000" data-delay="500"></div><span class="progress__number">35%</span>
										</div>
									</div><!-- End / progress -->
					...
					<div class="row">
						...
						<div class="col-md-6 col-lg-6 ">
							<div class="footer__social">
								...
								<!-- social-icon -->
								<a class="social-icon" href="https://web.facebook.com/fsgalang/"><i class="social-icon__icon fa fa-facebook"></i>
								</a><!-- End / social-icon -->
